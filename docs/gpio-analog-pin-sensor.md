...
![GPIO Analog Pin Sensor](assets/sfe-dl-gpio-analog-item.png)

Once enabled, a *Analog Pin Reading* device is added to the DataLogger IoT.

![Analog Pin Device](assets/sfe-dl-gpio-analog-dev.png)

## Analog Pin Reading Device

The Analog Pin Reading device has the following menu:

![Analog Pin Settings](assets/sfe-dl-gpio-analog-settings.png)
...
![Analog Pin Values](assets/sfe-dl-gpio-analog-pins.png)
