...
![System Update](assets/sfe-dl-adv-sys-update.png)
/// caption
System Update Menu
///
...
![Firmware List](assets/sfe-dl-adv-update-sdlist.png)
/// caption
Available Firmware Images on the SD Card
///
...
![Firmware Update!](assets/sfe-dl-adv-sd-updating.png)
/// caption
Firmware Updating from SD Card
///
