...
![Arduino Cloud Overview](/img/aiot_overview.png)
...
![Select Devices](/img/aiot_cloud_sel_devices.jpg)
...
![Add a Device](/img/aiot_dev_add.jpg)
...
![Select DIY Device](/img/aiot_dev_setup_sel.jpg)
...
![Name Device](/img/aiot_dev_name.jpg)
...
![Device Secret](/img/aiot_dev_secrets.jpg)
...
![API Keys](/img/aiot_cloud_api-k.jpg)
...
![Create Key](/img/aiot_cloud_create_key.jpg)
...
![API Key Name](/img/aiot_cloud_key_name.jpg)
...
![API KEY NOW](/img/aiot_cloud_key_secret.jpg)
...
![Arduino IoT Cloud Menu Options](/img/sparkfun_datalogger_iot_arduino_iot_cloud_menu.jpg)
...
> *TIP* To load the values by the system at startup using a JSON file and microSD card, you will need to [configure the Save Settings](settings/general/gen-save-settings.md). This JSON file will be created with the "**Save to Fallback**" option. Make sure to enable the Arduino IoT as well.
...
![Cloud Variables](/img/aiot_cloud_vars.jpg)
...
![Linked Variables](/img/aiot_dashboard_link.jpg)
...
![DataLogger IoT - 9DoF Dashboard](/img/aiot_dashboard.jpg)
...
![DataLogger IoT with Qwiic Environmental Combo Breakout (ENS160/BME280) Dashboard](/img/aiot_dashboard_qwiic_env.jpg)
