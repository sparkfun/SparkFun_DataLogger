...
<figure>
![Data File Menu Options](/img/sfe-datalogger-set-datafile.png )
<figcaption>Data File Menu Options</figcaption>
</figure>
...
<figure>
![Readings Saved In Text File Shown In A Windows File Explorer](/img/datalogger_iot_text_file.jpg)
<figcaption>Reading data value from Text File</figcaption>
</figure>
