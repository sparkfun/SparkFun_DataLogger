...
![External Serial Menu](/img/sfe-dl-gpio-ext-serial.png)
...
![Serial Device](/img/sfe-dl-gpio-ext-serial-dev.png)
...
![Serial Device Menu](/img/sfe-dl-gpio-ext-dev-settings.png)
