...
![Datalogger Iot And A Qwiic Device](/img/datalogger_iot_qwiic_u-blox_gnss_sam-m10q_module.jpg)

DataLogger IoT and several Qwiic-Enabled Devices Daisy Chained

![Datalogger And Several Qwiic-enabled Devices Daisy Chained](/img/datalogger_iot_qwiic_daisy_chained.jpg)
...
![LiPo Battery Inserted](/img/datalogger_iot_lipo_battery.jpg)
...
![Insert USB](/img/datalogger_iot_usb.jpg)
...
![Qwiic-Enabled Boards Connected And Stacked On The Datalogger Using Standoffs](/img/datalogger_iot_stacked_standoffs.jpg)
