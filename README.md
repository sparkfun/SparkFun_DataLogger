...
The documentation for the DataLogger, including hardware hookup and firmware use/configuration are detailed in the [DataLogger IoT Documentation](https://docs.sparkfun.com/SparkFun_DataLogger/).
...
* Version 01.5.01 - [Overview of the Release](docs/relnotes/rn_v010501.md)
* Version 01.5.00 - [Overview of the Release](docs/relnotes/rn_v010500.md)
